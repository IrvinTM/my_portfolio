...
export function Aboutme(){
    ...
    <div className="relative h-36"> 
        <div className="h-full w-full object-cover bg-gradient-to-r from-green-50  via-yellow-100 to-green-50 dark:from-slate-700 dark:via-slate-600 dark:to-slate-700"  />
        <div className="relative z-10 mx-auto -mt-14 size-28 overflow-hidden rounded-full border-4 border-slate-100 dark:border-slate-800">
            ...
            <img src="/src/assets/profile.jpeg" className="h-full object-cover transition duration-700 ease-out group-hover:scale-105" alt="avatar" />
        </div>
    </div>
    {/* <!-- Body --> */}
